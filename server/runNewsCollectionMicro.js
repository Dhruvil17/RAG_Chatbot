...
/**
 * Script to collect and store news articles in ChromaDB (t2.micro optimized)
 * Usage: node runNewsCollectionMicro.js
 */
...
const {
    collectAndStoreNews,
    getCollectionStats,
} = require("./newsCollectorMicro");

async function main() {
    console.log("🚀 Starting News Collection Process (t2.micro optimized)...");
